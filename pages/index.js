  ...
  return (
    <div className='bg-primary/60 h-full'>
        ...
        h-full container mx-auto'>
          <div>
            ...
            <motion.p
              ...
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vel nunc ligula.
              Praesent est neque, congue posuere urna quis, dapibus ornare diam. Etiam ac dolor
              sed diam dignissim varius sit amet sed urna. Morbi vel malesuada leo.
            </motion.p>
            {/* btn */}
      ...
      <div className='w-[1200px] h-full absolute right-0 bottom-0'>
        ...
        <ParticlesContainer />
        {/* avatar img */}
        <motion.div variants={fadeIn('up', 0.5)} initial="hidden"
